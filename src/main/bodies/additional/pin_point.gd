...
@export var connected_pin_point: NodePath
...
func _ready():
	print("This:", connected_pin_point)
	...
	if main_body.is_loaded:
		connect_pin_point(get_node(connected_pin_point))
